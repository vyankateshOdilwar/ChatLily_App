...
import com.example.chatlily.databinding.ItemReceiveBinding;
import com.example.chatlily.databinding.ItemSentBinding;
    ...
    public void onBindViewHolder(@NonNull RecyclerView.ViewHolder holder, int position) {
       ...
       int reactions [] = new int[]{
        ...
        ReactionPopup popup = new ReactionPopup(context, config, (pos) -> {
            ...
            //store feelings for sender in firebase database
            ...
            //store feelings for receiver in firebase database
            message.setFeeling(pos);
            FirebaseDatabase.getInstance().getReference()
                    .child("chats")
                    .child(receiverRoom)
